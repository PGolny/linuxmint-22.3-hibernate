[FAQ.md](https://github.com/user-attachments/files/26897285/FAQ.md)
# 常见问题排查 | FAQ
...
### 1. 执行休眠无反应 / 立即唤醒
- 步骤1：运行工具 1 确认配置全部正常
- 步骤2：BIOS 开启 S3 Sleep / 休眠支持
- 建议：关闭 Secure Boot（安全启动）

### 2. 休眠后唤醒黑屏、卡死
- 核心原因：显卡驱动兼容问题（NVIDIA 显卡尤为常见）
- 解决：
  1. 安装系统推荐的官方闭源驱动
  2. 驱动安装完成后，重新运行工具 4) 一键完整配置
